...
function create(conf, grunt) {
    conf = util.extend({
        fontName: function (i) {
            return 'ddv' + parseInt((''+(new Date).getTime()).slice(1)+Math.floor(Math.random()*100)+i).toString(32);
        },
